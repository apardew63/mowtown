      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-10 px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="flex-1 space-y-4 sm:space-y-6 text-center lg:text-left">
          ...
          <p className="leading-relaxed text-[#26402B] text-sm sm:text-base font-normal">
            ...
            the burden of lawn and landscaping maintenance. Our expert team at
            Mowtown Outdoors specialize in cultivating lush, manicured lawns and
          ...
          <button className="relative overflow-hidden group flex items-center gap-2 border-2 border-[#26402B] text-[#26402B] px-4 sm:px-1 py-2 sm:py-1 rounded-lg transition-all duration-500 mt-4 mx-auto lg:mx-0">
            <span className="relative z-10 flex items-center gap-2 transition-all duration-300 group-hover:text-white font-bold text-[16px]">
              Learn More
              <span className=" bg-[#4A9F44] rounded-md transition-transform duration-500 py-3 px-3">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-4 w-4 sm:h-5 sm:w-5 text-white transition-transform duration-500 rotate-45 group-hover:rotate-90"
                  fill="none"
        ...
        <div className="flex-1 flex justify-center mt-8 lg:mt-0">
          <img
            ...
            alt="Mowtown Feature"
            className="w-full max-w-sm sm:max-w-md lg:max-w-lg h-auto rounded-xl object-cover"
          />
        </div>
      </div>
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-10 px-4 sm:px-6 py-12 sm:py-16">
        ...
        <div className="flex-1 space-y-4 sm:space-y-6 text-center lg:text-left">
          ...
          <p className="leading-relaxed text-[#26402B] text-sm sm:text-base font-normal">
            ...
            dedicated to transforming outdoor spaces. Our seasoned professionals
            possess an intricate understanding of landscape dynamics,
            environmental considerations, and design intricacies, ensuring each
            project is meticulously crafted to perfection.
          </p>
